...
namespace Kubeeapp\CMSConfig;

use Kubeeapp\CMSConfig\Exceptions\ConstantAlreadyDefinedException;
use Kubeeapp\CMSConfig\Exceptions\UndefinedConfigKeyException;
...
class Config
{
     ...
     * ```
     * define('KCMS', 'no');
     * Config::define('KCMS', 'yes');
     * Config::apply();
     * // output: Fatal error: Uncaught Kubeeapp\Kcms\ConstantAlreadyDefinedException ...
     * ```
     *
     * @throws ConstantAlreadyDefinedException
     */
